...
intrinsic = \case
  ...
  "div-int" -> binaryInt "/"
  "mod-int" -> binaryInt "%"
  "not-int" -> pure $ ifLetPop "Int(a)" $ stackPushInt "!a"
  "or-int" -> binaryInt "|"
  "and-int" -> binaryInt "&"
  "xor-int" -> binaryInt "^"
  "gt-int" -> pure $ ifLetPop2 ("Int(a)", "Int(b)") $ convertBool "a > b"
  "eq-int" -> pure $ ifLetPop2 ("Int(a)", "Int(b)") $ convertBool "a == b"
  "gt_char" -> pure $ ifLetPop2 ("Char(a)", "Char(b)") $ convertBool "a > b"
  "eq_char" -> pure $ ifLetPop2 ("Char(a)", "Char(b)") $ convertBool "a == b"
  "add-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a + b"
  "sub-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a - b"
  "mul-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a * b"
  "div-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a / b"
  "mod-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a % b"
  "exp-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.exp()"
  "log-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.log10()"
  "sqrt-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.sqrt()"
  "sin-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.sin()"
  "cos-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.cos()"
  "tan-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.tan()"
  "asin-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.asin()"
  "acos-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.acos()"
  "atan-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.atan()"
  "atan2-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a.atan2(b)"
  "sinh-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.sinh()"
  "cosh-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.cosh()"
  "tanh-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.tanh()"
  "asinh-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.asinh()"
  "acosh-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.acosh()"
  "atanh-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.atanh()"
  "trunc-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.trunc()"
  "round-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.round()"
  "floor-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.floor()"
  "ceil-float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.ceil()"
  "gt-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ convertBool "a > b"
  "eq-float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ convertBool "(a - b).abs() < f64::EPSILON"
  "gt_string" -> pure $ ifLetPop2 ("Text(a)", "Text(b)") $ convertBool "a > b"
  "eq_string" -> pure $ ifLetPop2 ("Text(a)", "Text(b)") $ convertBool "a == b"
  "show-int" -> pure $ ifLetPop "Int(a)" $ stackPushText "format!(\"{:?}\", a)"
  "show-float" -> pure $ ifLetPop "Float(a)" $ stackPushText "format!(\"{:?}\", a)"
  "read-int" -> pure $ ifLetPop "Text(a)" $ convertOption "a.parse().ok().map(Int)"
  "read-float" -> pure $ ifLetPop "Text(a)" $ convertOption "a.parse().ok().map(Float)"
