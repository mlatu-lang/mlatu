...
intrinsic = \case
  ...
  "div_int" -> binaryInt "/"
  "mod_int" -> binaryInt "%"
  "not_int" -> pure $ ifLetPop "Int(a)" $ stackPushInt "!a"
  "or_int" -> binaryInt "|"
  "and_int" -> binaryInt "&"
  "xor_int" -> binaryInt "^"
  "gt_int" -> pure $ ifLetPop2 ("Int(a)", "Int(b)") $ convertBool "a > b"
  "eq_int" -> pure $ ifLetPop2 ("Int(a)", "Int(b)") $ convertBool "a == b"
  "gt_char" -> pure $ ifLetPop2 ("Char(a)", "Char(b)") $ convertBool "a > b"
  "eq_char" -> pure $ ifLetPop2 ("Char(a)", "Char(b)") $ convertBool "a == b"
  "add_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a + b"
  "sub_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a - b"
  "mul_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a * b"
  "div_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a / b"
  "mod_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a % b"
  "exp_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.exp()"
  "log_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.log10()"
  "sqrt_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.sqrt()"
  "sin_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.sin()"
  "cos_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.cos()"
  "tan_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.tan()"
  "asin_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.asin()"
  "acos_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.acos()"
  "atan_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.atan()"
  "atan2_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ stackPushFloat "a.atan2(b)"
  "sinh_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.sinh()"
  "cosh_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.cosh()"
  "tanh_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.tanh()"
  "asinh_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.asinh()"
  "acosh_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.acosh()"
  "atanh_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.atanh()"
  "trunc_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.trunc()"
  "round_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.round()"
  "floor_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.floor()"
  "ceil_float" -> pure $ ifLetPop "Float(a)" $ stackPushFloat "a.ceil()"
  "gt_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ convertBool "a > b"
  "eq_float" -> pure $ ifLetPop2 ("Float(a)", "Float(b)") $ convertBool "(a - b).abs() < f64::EPSILON"
  "gt_string" -> pure $ ifLetPop2 ("Text(a)", "Text(b)") $ convertBool "a > b"
  "eq_string" -> pure $ ifLetPop2 ("Text(a)", "Text(b)") $ convertBool "a == b"
  "show_int" -> pure $ ifLetPop "Int(a)" $ stackPushText "format!(\"{:?}\", a)"
  "show_float" -> pure $ ifLetPop "Float(a)" $ stackPushText "format!(\"{:?}\", a)"
  "read_int" -> pure $ ifLetPop "Text(a)" $ convertOption "a.parse().ok().map(Int)"
  "read_float" -> pure $ ifLetPop "Text(a)" $ convertOption "a.parse().ok().map(Float)"
