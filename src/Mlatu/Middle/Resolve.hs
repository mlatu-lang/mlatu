...
value _ _ Capture {} = ice "closure should not appear before name resolution"
value _ _ v@Character {} = pure v
value _ _ Closed {} = ice "closed name should not appear before name resolution"
value _ _ Local {} = ice "local name should not appear before name resolution"
        ...
        then pure name
          ...
          if isDefined qualified'
            then pure $ QualifiedName qualified'
              ...
              lift $ reportCannotResolveName origin category name
              pure name
    LocalName {} -> ice "local name should not appear before name resolution"
